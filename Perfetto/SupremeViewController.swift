...
class SupremeViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        ingredientsLabel.text = "\u{2022} Mushrooms \n\u{2022} Bell Peppers \n\u{2022} Olives"
...
//extension SupremeViewController: UITextFieldDelegate {
//
